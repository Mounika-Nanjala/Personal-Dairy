...
const SearchUI = ({
  ...
  return (
    <div className="md:flex md:flex-row justify-between space-y-2 md:space-y-0 md:space-x-2 mb-4">
      ...
      <input
        ...
        className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-2 rounded w-full text-gray-900 dark:text-gray-100"
      />
      ...
      <Button
        ...
        className="bg-blue-500 dark:bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-600 dark:hover:bg-blue-800 flex-1 w-full md:w-auto"
      />
      ...
      <Button
        ...
        className="bg-gray-500 dark:bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600 dark:hover:bg-gray-800 flex-1 w-full md:w-auto"
      />
    </div>
  );
};
